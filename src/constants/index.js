...
export default Object.defineProperties(constants, {
    CHANGE_PAGE_SUCCESS: { value: 'change_page_success', writable: false },
    CHANGE_PAGE_REQUEST: { value: 'change_page_request', writable: false },
    SORT_DIRECTION_SUCCESS: { value: 'sort_direction_success', writable: false },
    SORT_DIRECTION_REQUEST: { value: 'sort_direction_request', writable: false },
    SORT_FIELD_SUCCESS: { value: 'sort_field_success', writable: false },
